...
* **tflint:** 🐛 bump Azure rules version, fix signature bug 457274e

### Miscellaneous Chores

* **deps:** update dependency opentofu to v1.12.1 b51ecb9
* **deps:** update dependency opentofu to v1.12.2 00a7d6c
* **deps:** update dependency opentofu to v1.12.3 22b4f79
* **deps:** update dependency opentofu to v1.12.4 1952799
* **deps:** update dependency tflint to v0.63.1 407397a
* **deps:** update pre-commit hook tofuutils/pre-commit-opentofu to v2.4.1 a9fe737
* **deps:** update pre-commit hook tofuutils/pre-commit-opentofu to v2.4.2 908ebc3

## 8.1.4 (2026-06-02)

### Bug Fixes

* 🐛 default output `resource` now require sensitive with OpenTofu 1.12+ 234c555

### Miscellaneous Chores

* **deps:** 🔗 update mise conf for OpenTofu f862e08
* **deps:** update dependency opentofu to v1.12.0 b582be5
* **deps:** update dependency terraform-docs to v0.23.0 f603ebd
* **deps:** update dependency terraform-docs to v0.24.0 96fdcab
* **deps:** update pre-commit hook tofuutils/pre-commit-opentofu to v2.3.0 1a10123
* **deps:** update pre-commit hook tofuutils/pre-commit-opentofu to v2.4.0 4722a9b
* **deps:** update tools bd3714a
* **pre-commit:** 🔧 move to prek aee6bfb
* **tfdocs:** bump tfdocs to v0.22 🔧 5e6f40b

## 8.1.3 (2026-03-27)

### Bug Fixes

* **trivy:** 🐛 drop unsafe trivy pre-commit 🔒️ 9ef2f62

### Code Refactoring

* update module structure and Github actions 👷 61daa13

### Miscellaneous Chores

* **AI:** 🤖 add AI Agents instructions for Contributing 855cdc6
* **deps:** 🔗 bump tflint rules version 09848ee
* **deps:** update dependency trivy to v0.69.2 a542553
* **deps:** update dependency trivy to v0.69.3 aee307a
* **deps:** update pre-commit hook crate-ci/committed to v1.1.11 3df72cc

## 8.1.2 (2026-02-13)

### Code Refactoring

* **gitlab MR template:** ♻️ update default reviewers group with Azure Factory 🔧 cf5fc25

### Miscellaneous Chores

* **deps:** update dependency opentofu to v1.10.7 69988bb
* **deps:** update dependency opentofu to v1.11.2 0c12374
* **deps:** update dependency opentofu to v1.11.3 843c556
* **deps:** update dependency opentofu to v1.11.4 e7ad541
* **deps:** update dependency opentofu to v1.11.5 e2fc58e
* **deps:** update dependency pre-commit to v4.4.0 64651b9
* **deps:** update dependency pre-commit to v4.5.0 862cb23
* **deps:** update dependency pre-commit to v4.5.1 e083866
* **deps:** update dependency tflint to v0.60.0 61612be
* **deps:** update dependency tflint to v0.61.0 bc5cc8c
* **deps:** update dependency trivy to v0.67.1 7929778
* **deps:** update dependency trivy to v0.67.2 8a2f780
* **deps:** update dependency trivy to v0.68.1 19f2436
* **deps:** update dependency trivy to v0.68.2 fed8a4a
* **deps:** update dependency trivy to v0.69.0 a2bfcc4
* **deps:** update dependency trivy to v0.69.1 4d08936
* **deps:** update pre-commit hook crate-ci/committed to v1.1.10 dd8465e
* **deps:** update pre-commit hook crate-ci/committed to v1.1.8 7a07609
* **deps:** update pre-commit hook crate-ci/committed to v1.1.9 07fca19
* **deps:** update pre-commit hook tofuutils/pre-commit-opentofu to v2.2.2 f3e7293
* **deps:** update tools 41521ca
